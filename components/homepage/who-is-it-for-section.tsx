    ...
    <section className="py-20 lg:py-28 bg-white border-b border-[#DCE5E4] font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Card 1 — For Learners */}
          <div className="p-8 sm:p-10 rounded-3xl bg-[#F5F7F8] border border-[#DCE5E4] hover:border-[#0B4F4B]/40 transition-all flex flex-col justify-between space-y-8 relative overflow-hidden group shadow-sm hover:shadow-xl">
            <div className="absolute top-0 right-0 w-36 h-36 bg-[#0B4F4B]/5 rounded-bl-full pointer-events-none group-hover:scale-110 transition-transform" />

            <div className="space-y-5 relative z-10">
              <div className="p-3.5 rounded-2xl bg-[#0B4F4B] text-white w-fit shadow-md">
                <GraduationCap className="h-7 w-7" />
              </div>
              <div>
                <span className="text-xs font-black text-[#0B4F4B] uppercase tracking-wider">
                  FOR LEARNERS
                </span>
              ...
              <div className="space-y-2 pt-2 text-xs font-semibold text-[#102A2A]">
                <div className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-[#0B4F4B]" />
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-[#FBF7EE] border border-[#F2C14E]/40 hover:border-[#F2C14E] transition-all flex flex-col justify-between space-y-8 relative overflow-hidden group shadow-sm hover:shadow-xl">
            ...
            <div className="relative z-10 pt-4 border-t border-[#F2C14E]/30">
              <Link href="/teacher">
                <GlassButton
                  variant="secondary"
                  className="bg-[#1B6863] hover:bg-[#0B4F4B] text-white font-extrabold px-6 rounded-full"
                  rightIcon={<ArrowRight className="h-4 w-4" />}
                >
                  Become an Educator →
                </GlassButton>
