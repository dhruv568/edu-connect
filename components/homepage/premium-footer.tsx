...
export function PremiumFooter({ showCta = false }: PremiumFooterProps = {}) {
  ...
  return (
    <footer className="bg-[#083F3D] text-white pt-16 pb-12 border-t border-[#1B6863]/40 relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 sm:gap-10 pb-12 border-b border-[#1B6863]/60">
          ...
          <div className="space-y-4 md:col-span-4">
            ...
            <p className="text-xs sm:text-[13px] text-teal-100 leading-relaxed font-normal">
            ...
            <div className="p-4 rounded-2xl bg-[#052C2A]/90 border border-[#1B6863] text-xs space-y-1.5 shadow-sm">
              <p className="font-bold text-white text-xs">Shrivastava ProFunnels Ventures Pvt Ltd</p>
              <p className="font-mono text-teal-200 text-xs font-semibold">CIN: U85499UP2024PTC212061</p>
              <p className="text-teal-100 text-xs leading-relaxed font-normal">
            ...
            {socialLinks.length > 0 && (
              <div className="pt-2">
                <p className="text-[11px] uppercase tracking-wider font-extrabold text-teal-200 mb-2.5">
                  Connect With Us
                </p>
                  ...
                  {socialLinks.map((item) => {
                    ...
                    return (
                      <a
                        ...
                        className={`h-9 w-9 rounded-xl bg-[#0F5C5A] border border-[#2A8C84]/50 flex items-center justify-center text-white transition-all duration-200 ${item.hoverClass} hover:bg-[#052C2A] hover:border-white shadow-xs`}
                      >
          ...
          <div className="md:col-span-3 space-y-6">
            <div>
              ...
              <ul className="space-y-3 text-xs sm:text-[13px] font-medium">
                <li>
                  <Link href="/about" className="text-teal-100 hover:text-white hover:translate-x-0.5 transition-all flex items-center gap-2.5">
                    <Info className="h-3.5 w-3.5 text-[#2A8C84] shrink-0" />
                    <span>About Us</span>
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="text-teal-100 hover:text-white hover:translate-x-0.5 transition-all flex items-center gap-2.5">
                    <Mail className="h-3.5 w-3.5 text-[#2A8C84] shrink-0" />
                    <span>Contact Us</span>
                  </Link>
                </li>
                <li>
                  <Link href="/#success-stories" className="text-teal-100 hover:text-white hover:translate-x-0.5 transition-all flex items-center gap-2.5">
                    <Award className="h-3.5 w-3.5 text-[#2A8C84] shrink-0" />
                    <span>Success Stories</span>
                  </Link>
                </li>
                <li>
                  <Link href="/terms-and-conditions" className="text-teal-100 hover:text-white hover:translate-x-0.5 transition-all flex items-center gap-2.5">
                    <FileText className="h-3.5 w-3.5 text-[#2A8C84] shrink-0" />
                    <span>Terms & Conditions</span>
                  </Link>
                </li>
                <li>
                  <Link href="/privacy-policy" className="text-teal-100 hover:text-white hover:translate-x-0.5 transition-all flex items-center gap-2.5">
                    <ShieldCheck className="h-3.5 w-3.5 text-[#2A8C84] shrink-0" />
                    <span>Privacy Policy</span>
                  </Link>
                </li>
                <li>
                  <Link href="/refund-policy" className="text-teal-100 hover:text-white hover:translate-x-0.5 transition-all flex items-center gap-2.5">
                    <RefreshCw className="h-3.5 w-3.5 text-[#2A8C84] shrink-0" />
                    <span>Cancellation & Refund</span>
                  </Link>
                </li>
                <li>
                  <Link href="/shipping-policy" className="text-teal-100 hover:text-white hover:translate-x-0.5 transition-all flex items-center gap-2.5">
            ...
            <div className="p-4 bg-[#052C2A]/90 rounded-2xl border border-[#1B6863] text-xs space-y-1.5 shadow-sm">
              <div className="flex items-center gap-2 font-bold text-white text-xs">
                <CreditCard className="h-4 w-4 text-[#2A8C84] shrink-0" />
                <span>Cashfree Payment Gateway</span>
              </div>
              <p className="text-[12px] text-teal-100 leading-relaxed font-normal">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-teal-100 pt-4">
