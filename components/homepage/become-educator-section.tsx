  ...
  return (
    <section className="py-20 lg:py-28 bg-[#FBF7EE] border-b border-[#DCE5E4] font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-8 sm:p-12 lg:p-16 rounded-3xl bg-[#0B4F4B] text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
            ...
            <div className="lg:col-span-5">
              <div className="p-6 rounded-3xl bg-[#073F3C] border border-[#1B6863] shadow-xl space-y-4 text-left">
                <div className="flex items-center gap-3">
                  <div className="p-3 rounded-2xl bg-[#0B4F4B] text-[#F2C14E]">
                ...
                <div className="p-4 rounded-2xl bg-[#0B4F4B]/60 border border-[#1B6863]/60 space-y-2 text-xs text-teal-100/80">
