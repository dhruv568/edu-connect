        ...
        {showRefundModal && (
          <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-lg w-full p-6 sm:p-8 space-y-6 shadow-2xl text-slate-100">
              ...
              {/* Explanatory Banner: Request, Not Immediate Refund */}
              <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/25 text-xs text-amber-200 space-y-1">
                ...
                <p className="text-amber-200/90 leading-relaxed">
                  This form submits a formal refund <strong>REQUEST</strong> for moderation. Submitting this request does not immediately issue a refund. Our team will review your request against the EduConnects Refund Policy (valid within 24 hours of purchase) and update the refund status.
                </p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-950/60 border border-slate-800 space-y-2 text-xs">
                <div className="flex justify-between">
                  <span className="text-slate-400">Purchased Service:</span>
                  <span className="font-bold text-white text-right">{receipt.productTitle}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Order Reference:</span>
                  <span className="font-mono text-slate-300">{receipt.internalReference}</span>
                </div>
                <div className="flex justify-between">
              ...
              <form onSubmit={handleSubmitRefundRequest} className="space-y-4 text-xs">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    required
                    className="w-full h-11 px-3.5 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 text-xs"
                  >
                    <option value="">Select a reason...</option>
                    <option value="Course content did not match syllabus or expectations">
                      Course content did not match syllabus or expectations
                    </option>
                    <option value="Accidental or duplicate purchase">
                      Accidental or duplicate purchase
                    </option>
                    <option value="Technical or video streaming playback issues">
                      Technical or video streaming playback issues
                    </option>
                    <option value="Class schedule conflict or unable to attend session">
                      Class schedule conflict or unable to attend session
                    </option>
                    <option value="Educator unavailable or session rescheduled">
                      Educator unavailable or session rescheduled
                    </option>
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    placeholder="Provide any additional context or details for our team..."
                    className="w-full p-3 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 text-xs resize-none"
                  />
                </div>
                ...
                <div className="flex items-center justify-end gap-3 pt-2 border-t border-slate-800">
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 rounded-xl text-xs font-bold bg-rose-600 hover:bg-rose-500 text-white disabled:opacity-50 transition-all shadow-md cursor-pointer flex items-center gap-2"
                  >
                    {submittingRefund ? (
                      <>
